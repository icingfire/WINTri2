...
if (Test-Path C:\Windows\appcompat\Programs\Amcache.hve)
{
    ...
    esentutl /y /vss "C:\Windows\appcompat\Programs\Amcache.hve.LOG1" /d "$Destination\$Triage\OS\AppCompat\Amcache.hve.LOG1" | Out-Null
    esentutl /y /vss "C:\Windows\appcompat\Programs\Amcache.hve.LOG2" /d "$Destination\$Triage\OS\AppCompat\Amcache.hve.LOG2" | Out-Null
}
...
try {
    ...
    Write-Host "Compress failed! " $_.Exception.Message
}
